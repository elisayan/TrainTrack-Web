<section class="search-ticket-section">
    <div class="row">
        <div class="col-12">
            <h2 class="search-title text-center mb-5">Trova il tuo biglietto</h2>
        </div>
        <div class="col-12 col-md-6">
            <form class="card shadow p-3 mb-5" action="search-tickets-results.php" method="GET"
                aria-label="ricerca biglietto">
                ...
                <div class="row justify-content-center">
                    <div class="row station">
                        <div class="col-md-12">
                            ...
                            <input class="form-control" list="datalistStation" id="stazione_partenza"
                                name="stazione_partenza" required />
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" list="datalistStation" id="stazione_arrivo"
                                name="stazione_arrivo" required />
                        </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <input class="form-control" type="time" id="orario_partenza"
                                            name="orario_partenza" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="row adult justify-content-end">
                                        <div class="col-auto passenger">
                                            <label for="numero_biglietti_adulti"><img src="./img/user.png"
                                                    alt="Biglietti per adulti"></label>
                                        </div>
                                        <div class="col-auto passenger">
                                            <button type="button" class="passenger"
                                                onclick="updateTickets('numero_biglietti_adulti', -1)"><img
                                                    src="./img/minus.png" alt="Togli un biglietto per adulto"></button>
                                        </div>
                                        <div class="col-auto passenger">
                                            <input type="text" value="1" id="numero_biglietti_adulti"
                                                name="numero_biglietti_adulti"
                                                aria-label="numero biglietti per adulti aggiunti" readonly>
                                        </div>
                                        <div class="col-auto passenger">
                                            <button type="button" class="passenger"
                                                onclick="updateTickets('numero_biglietti_adulti', 1)"><img
                                                    src="./img/more.png"
                                                    alt="Aggiungi un biglietto per adulto"></button>
                                        </div>
                                    </div>

                                    <div class="row kid justify-content-end">
                                        <div class="col-auto passenger">
                                            <label class="kid" for="numero_biglietti_bambini"><img src="./img/user.png"
                                                    alt="Biglietti per bambini"></label>
                                        </div>
                                        <div class="col-auto passenger">
                                            <button type="button" class="passenger"
                                                onclick="updateTickets('numero_biglietti_bambini', -1)"><img
                                                    src="./img/minus.png"
                                                    alt="Togli un biglietto per un bambino"></button>
                                        </div>
                                        <div class="col-auto passenger">
                                            <input type="text" value="0" id="numero_biglietti_bambini"
                                                name="numero_biglietti_bambini"
                                                aria-label="numero di biglietti per bambini aggiunti" readonly>
                                        </div>
                                        <div class="col-auto passenger">
                                            <button type="button" class="passenger"
                                                onclick="updateTickets('numero_biglietti_bambini', 1)"><img
                                                    src="./img/more.png"
                                                    alt="Aggiungi un biglietto per un bambino"></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
