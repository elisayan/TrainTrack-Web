<section class="search-subscription-section">
    <div class="row">
        <div class="col-12">
            <h2 class="search-title text-center mb-5">Scegli il tuo abbonamento</h2>
        </div>
        <div class="col-12 col-md-6">
            ...
            <form class="card shadow subscription p-4 mt-0 mb-5" action="search-subscriptions-results.php" method="GET"
                aria-label="ricerca abbonamento">
                    ...
                    <div class="row justify-content-center">
                        <div class="row station">
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input class="form-control" list="datalistStation" id="departure-station"
                                    name="departure-station" required />
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input class="form-control" list="datalistStation" id="destination-station"
                                    name="destination-station" required />
                                <datalist>
                                    <?php foreach ($templateParams["nome_stazioni"] as $stazione): ?>
                                        <option value="<?php echo $stazione["nome_stazioni"]; ?>">
                                        <?php endforeach; ?>
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <select class="form-select" aria-label="duration" name="duration" id="duration">
                                    ...
                                    <?php foreach ($templateParams["durate"] as $durate): ?>
                                        <option value="<?php echo $durate["durate"]; ?>"><?php echo $durate["durate"]; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <select class="form-select" aria-label="train-type" name="train-type" id="train-type">
                                    ...
                                    <?php foreach ($templateParams["tipo_treni"] as $tipo_treni): ?>
                                        <option value="<?php echo $tipo_treni["tipo_treni"]; ?>">
                                            <?php echo $tipo_treni["tipo_treni"]; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <div class="card sub-card shadow"
                            onclick="searchSub('Bologna Centrale', 'Forlì', 'Intercity', 'Settimanale')" role="button">
                            <div class="card-body">
                    ...
                    <div class="carousel-item">
                        <div class="card sub-card shadow"
                            onclick="searchSub('Piacenza', 'Parma', 'Frecciarossa', 'Mensile')" role="button">
                            <div class="card-body">
                    ...
                    <div class="carousel-item">
                        <div class="card sub-card shadow"
                            onclick="searchSub('Bologna Centrale', 'Ravenna', 'Regionale', 'Annuale')" role="button">
                            <div class="card-body">
