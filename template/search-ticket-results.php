                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-8 data">
                                <input type="text" readonly class="form-control-plaintext" id="tipo-treno"
                                    value="<?php echo $biglietto["tipotreno"]; ?>">
                                <div class="row">
                                    <div class="col-7">
                                        <input type="text" readonly class="form-control-plaintext" id="data-partenza"
                                            value="<?php echo $biglietto["datapartenza"]; ?>">
                                    </div>
                                    <div class="col-5">
                                        <input type="text" readonly class="form-control-plaintext" id="orario-partenza"
                                            value="<?php echo $biglietto["orariopartenza"]; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-7">
                                        <input type="text" readonly class="form-control-plaintext" id="data-arrivo"
                                            value="<?php echo $biglietto["dataarrivo"]; ?>">
                                    </div>
                                    <div class="col-5">
                                        <input type="text" readonly class="form-control-plaintext" id="orario-arrivo"
                                            value="<?php echo $biglietto["orarioarrivo"]; ?>">
                                    </div>
                                </div>
                                <input type="text" readonly class="form-control-plaintext" id="prezzo"
